...
public class CalendarAppointmentServiceImpl implements CalendarAppointmentService {
    ...
    public Map<String, Object> freeSlotList(String userTimeZone, FreeSlotListDto freeSlotListDto) {
        ...
        try {
            ...
            if (aasAvailableYN.equals("Y")) {
                ...
                List<com.q4magic.common.models.Calendar> bookSlotList = this.calendarRepository
                        .findBookList(customers.getId(), slotDateTime);
    ...
    public Map<String, Object> saveAppointment(Map<String, Object> calendarData) {
        ...
        try {
            ...
            if (isDirectBooking && !timeSlots.isEmpty()) {
                ...
                List<Calendar> existingBookings = this.calendarRepository.findBookList(customers.getId(), slotDate);
                Calendar calendar = null;
                for (Calendar existing : existingBookings) {
                    if (existing.getCalStartDateTime() != null && calStartDate != null
                            && existing.getCalStartDateTime().equals(calStartDate)) {
                        calendar = existing;
                        break;
                    }
                }
                ...
                // Google & Outlook Sync
                List<CalendarDetails> calendarDetailsList = this.calendarDetailsRepository.findCalendarDetailsList(calendar.getId());
                ...
                if (customers.getGoogleCalendarRefreshToken() != null && !customers.getGoogleCalendarRefreshToken().isEmpty()) {
                    try {
                        ...
                        googleCalendarDto.setCalDescription(calendar.getCalDescription() != null ? calendar.getCalDescription() : "");
                        ...
                        Map<String, Object> gRes = this.googleCalendarService.saveEvent(customers.getId(), googleCalendarDto);
                ...
                if (customers.getOutlookCalendarRefreshToken() != null && !customers.getOutlookCalendarRefreshToken().isEmpty()) {
                    try {
                        ...
                        outlookCalendarDto.setCalDescription(calendar.getCalDescription() != null ? calendar.getCalDescription() : "");
                        outlookCalendarDto.setCalStartDateTime(selectedStart);
                        outlookCalendarDto.setCalEndDateTime(selectedEnd);
                        outlookCalendarDto.setCalAllDay(calendar.getCalAllDay() != null ? calendar.getCalAllDay() : "false");
                        ...
                        Map<String, Object> oRes = this.outlookCalendarService.saveEvent(customers.getId(), outlookCalendarDto);
                ...
                String encodedTargetCalId = Base64.getUrlEncoder().encodeToString(String.valueOf(targetCalId).getBytes(StandardCharsets.UTF_8));
                    ...
                    try {
                        ...
                        if (finalMemEmail != null && !finalMemEmail.equals("")) {
                            ...
                            String body = "<!DOCTYPE html>" +
                                    ...
                                    "<div class=\"container\">" +
                                    "<div class=\"header\">" +
                                    "<img src=\"" + finalSiteUrl + "images/logo/360Pipe_logo.png\" alt=\"Site Logo\" class=\"logo\">" +
                                    "</div>" +
                                    "<div class=\"content\">" +
                                    "<p>Hi " + finalFirstName + " " + finalLastName + ", A new meeting has been scheduled. </p>" +
                                    "<p><b>Event Type:</b></p><p>" + (finalEventType != null ? finalEventType.getTitle() : "Meeting")
                                    + "<br /><br /></p>" +
                                    "<p><b>Invitee:</b></p><p>" + finalTitle + "<br /><br /></p>" +
                                    "<p><b>Invitee Email:</b></p><p>" + finalInviteeEmail + "<br /><br /></p>" +
                                    finalGuestsHtml +
                                    "<p><b>Invitee Date/Time:</b></p><p>" + this.commonService.dbDateToDisplayDateTime(finalDbStart)
                                    + "<br /><br /></p>" +
                                    "<p><b>Invitee Timezone:</b></p><p>" + finalCalTimeZone + "<br /><br /></p>" +
                                    "<p><b>Your Date/Time:</b></p><p>"
                                    + this.commonService.dbDateToDisplayDateTime(
                                    this.commonService.convertEventTimeZoneToUserDB(finalDbStart, finalCalTimeZone, finalMemTimeZone))
                                    + "<br/>"
                                    + "<a href=\"" + finalEditAppointmentUrl + "\" target=\"_blank\" style=\"background-color: #44288E; color: #ffffff !important; padding: 7px 16px; border-radius: 6px; text-decoration: none; font-weight: bold; font-size: 13px; display: inline-block; margin-top: 8px;\">Edit Date/Time</a>"
                                    + "<br /><br /></p>" +
                        ...
                        for (int i = 0; i < finalAttendees.length(); i++) {
                            ...
                            if (!email.equals(finalMemEmail)) {
                                ...
                                String body = "<!DOCTYPE html>" +
                                        ...
                                        "</div>" +
                                        "<div class=\"content\">" +
                                        "<p>Hi " + (finalTitle != null && !finalTitle.isEmpty() ? finalTitle : "there") + ", Your "
                                        + (finalEventType != null ? finalEventType.getTitle() : "Meeting") + " with " + finalFirstName + " "
                                        + finalLastName + " at " + this.commonService.dbDateToDisplayDateTime(finalDbStart) + " "
                                        + finalCalTimeZone + " is scheduled. </p>" +
                                        "<p><a href=\"" + finalEditAppointmentUrl + "\" target=\"_blank\" style=\"background-color: #44288E; color: #ffffff !important; padding: 7px 16px; border-radius: 6px; text-decoration: none; font-weight: bold; font-size: 13px; display: inline-block; margin-top: 6px;\">Edit Date/Time</a></p>" +
                                        finalComment +
                                        finalGuestsHtml +
                                        "<p>If you have any questions, please contact us at <a href=\"mailto:360pipeinc@gmail.com\">360pipeinc@gmail.com</a>.</p>" +
                                        "<p>Thank you for your understanding.</p>" +
                                        ...
                                        "</body>" +
                                        "</html>";
                                this.commonService.sendEmailWithAttachment(email, subject, body, true, finalFileName, finalFilePath);
                            }
                        }
                    } catch (Exception ex) {
                        ex.printStackTrace();
            ...
            for (int i = 0; i < timeSlots.size(); i++) {
                ...
                slotsHtml.append(
                        ...
                        .append("<div style=\"font-size: 12px; color: #64748b; margin-top: 4px;\">Timezone: ").append(calTimeZone)
                        .append("</div>")
                        .append("</td>")
    ...
    public Map<String, Object> setAcceptOrRejectAppointment(Map<String, Object> payload) {
        ...
        try {
            ...
            String encodedCusId = Base64.getUrlEncoder().encodeToString(String.valueOf(customers.getId()).getBytes(StandardCharsets.UTF_8));
            Integer targetCalId = calendar.getId() != null ? calendar.getId() : 0;
            String encodedTargetCalId = Base64.getUrlEncoder().encodeToString(String.valueOf(targetCalId).getBytes(StandardCharsets.UTF_8));
            String editAppointmentUrl = siteUrl + "edit-appointment?id=" + encodedTargetCalId + "&v=" + encodedCusId;
